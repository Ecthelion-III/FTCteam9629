 ...
 */
public class TestBot extends PushBotTelemetry

{
...

    {
        ...
        float frontLeftMotor = scale_motor_power(gamepad1.right_stick_x - gamepad1.right_stick_y);
        float frontRightMotor = scale_motor_power(gamepad1.right_stick_x + gamepad1.right_stick_y);
        float backLeftMotor = scale_motor_power(gamepad1.right_stick_x - gamepad1.right_stick_y);
        float backRightMotor = scale_motor_power(gamepad1.right_stick_x + gamepad1.right_stick_y);
